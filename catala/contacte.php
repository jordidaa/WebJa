    ...
    <body class="inici">
        ...
        <div class="row mt-5 mb-5">
            ...
            <form action=""  method="post" class="needs-validation" novalidate>
                <div class="form-row">
                    <div class="col-xl-12 col-md-12 mb-3">
                            <input type="text" class="form-control" id="validationCustom01" placeholder="Nom i cognoms" name="nom" required>
                    </div>    
                </div>
                ...
                <div class="form-row">
                    <div class="col-xl-12 col-md-12 mb-3">
                            <input type="tel" class="form-control" id="validationCustom03" placeholder="Telèfon" name="telefon" required>
                                <div class="invalid-feedback">
                                Posa un telèfon valid
                                </div>
                    </div>    
                </div>
                <div class="form-row">
                    <div class="col-xl-12 col-md-12 mb-3">
                        <div class="form-group">
                            <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Missatge" name="missatge" rows="3"></textarea>
                        </div>
                    </div>
            </div>
            <div class="col-xl-12 col-md-12 mb-3">
            <div class="form-group">
                <div class="form-check">
                    ...
                    <label class="form-check- roboto" for="invalidCheck">
                        Accepto la <a class="negre" href="https://jardineriaalgarrada.000webhostapp.com/catala/politica-de-privadesa.php">política de privadesa</a>
                    </label>
                    <div class="invalid-feedback">
                        Fes click per poder enviar
                    </div>
                </div>
            </div>
            <div class="form-row">
            ...
            if(isset($_POST['submit'])){
                ...
                echo "Missatge enviat. Gràcies " . $nom . ", contactarem amb tu properament.";
