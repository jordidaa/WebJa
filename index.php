            ...
            <p class="mt-3 text-center pad30lat roboto">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vulputate vehicula vestibulum. 
                ...
                <div class="row inicidoscol verdclarbg">
                    ...
                    <div class="col-xl-6 col-md-12">
                        ...
                        <button id="singlebutton" name="singlebutton" class="btn btn-primary botbrown btnmesinfo roboto" onclick="window.location.href='catala/quisom.php';">Més informació</button>                       
                    </div>
                </div>
                <div class="row inicidoscol verdfoscbg">
                    <div class="col-xl-6 order-xl-2 col-md-12 order-12">
                        <h2 class="mt-4 text-center  bebas">Jardins</h2>
                        <p class="mt-2 text-center mx-4 roboto">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vulputate vehicula vestibulum. 
                        Praesent sit amet nisi justo. Nulla sit amet purus nec arcu vestibulum porta. Pellentesque feugiat metus vel augue 
                        euismod ornare. Aliquam sem augue, aliquet quis ex quis, laoreet malesuada lacus.</p>
                ...
                <div class="row inicidoscol verdclarbg">
                    ...
                    <div class="col-xl-6 col-md-12">
                        ...
                        Praesent sit amet nisi justo. Nulla sit amet purus nec arcu vestibulum porta. Pellentesque feugiat metus vel augue 
                        euismod ornare. Aliquam sem augue, aliquet quis ex quis, laoreet malesuada lacus.</p>
                        <button id="singlebutton" name="singlebutton" class="btn btn-primary botbrown btnmesinfo roboto" onclick="window.location.href='catala/paisatgisme.php';">Més informació</button>                       
                    </div>
                </div>
                <div class="row inicidoscol verdfoscbg">
                    <div class="col-xl-6 order-xl-2 col-md-12 order-12">
                        <h2 class="mt-4 text-center  bebas">Sistemes de reg</h2>
                        <p class="mt-2 text-center mx-4 roboto">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vulputate vehicula vestibulum. 
                        Praesent sit amet nisi justo. Nulla sit amet purus nec arcu vestibulum porta. Pellentesque feugiat metus vel augue 
                        euismod ornare. Aliquam sem augue, aliquet quis ex quis, laoreet malesuada lacus.</p>
                ...
                <div class="row inicidoscol verdclarbg">
                    ...
                    <div class="col-xl-6 col-md-12">
                        ...
                        Praesent sit amet nisi justo. Nulla sit amet purus nec arcu vestibulum porta. Pellentesque feugiat metus vel augue 
                        euismod ornare. Aliquam sem augue, aliquet quis ex quis, laoreet malesuada lacus.</p>
                        <button id="singlebutton" name="singlebutton" class="btn btn-primary botbrown btnmesinfo roboto" onclick="window.location.href='catala/piscines.php';">Més informació</button>                       
                    </div>
                </div>
                <div class="row inicidoscol verdfoscbg">
                    <div class="mt-4 col">
                    ...
                    <div>
                        ...
                        Praesent sit amet nisi justo. Nulla sit amet purus nec arcu vestibulum porta. Pellentesque feugiat metus vel augue 
                        euismod ornare. Aliquam sem augue, aliquet quis ex quis, laoreet malesuada lacus.</p>
                        <button id="singlebutton" name="singlebutton" class="btn btn-primary botbrown btnmesinfo roboto" onclick="window.location.href='catala/manteniment.php';">Més informació</button>
                    </div>
                </div>
        <footer>
